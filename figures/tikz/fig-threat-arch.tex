...
\begin{tikzpicture}[>=Stealth,font=\small,
  ...
  \node[actor,fill=black!8] (S) at (6.0,0) {Service operator\\\footnotesize message delivery and\\\footnotesize KT directory server};
  ...
  \draw[<->] (A.east) -- ([yshift=2mm]S.west);
  \draw[<->] (B.east) -- ([yshift=-2mm]S.west);
  \node[font=\footnotesize,align=center] at (6.0,-1.9) {service operator:\\potentially malicious};
