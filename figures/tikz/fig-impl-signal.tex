...
\begin{tikzpicture}[>=Stealth,font=\footnotesize,
  ...
  \node[sub,minimum width=6.0cm] (hooks) at (0,0.85)
        {hooks: key upload \,|\, key lookup \,|\, session establishment};
  ...
  \draw[->,dashed] (aud) -- node[left,align=center,fill=white,inner sep=1pt,font=\scriptsize]{poll STH,\\deltas, proofs} (srv);
  \draw[->,dashed,red!60!black] (atk) -- node[right,align=center,font=\scriptsize]{stage\\attack} (srv);
\end{tikzpicture}
