...
\begin{tikzpicture}[>=Stealth,font=\footnotesize]
  ...
  \node[red!70!black] at (4,1.55){synthetic baseline: $W$ proofs, cost $O(W\log n)$};
  % windowed: single proof m -> n (lower arc)
  \draw[->,green!45!black,very thick] (0,-0.18) to[bend right=26] (8,-0.18);
  \node[green!45!black] at (4,-1.95){windowed: one proof $\pcons(m,n)$, cost $O(\log n)$};
\end{tikzpicture}
