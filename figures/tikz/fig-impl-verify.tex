...
\begin{tikzpicture}[>=Stealth,font=\footnotesize,
  ...
  \node[hd] (s) at (7.4,0) {\textbf{Directory server}};
  ...
  \draw[<-] (0,-2.0) -- node[above,font=\scriptsize]{value, proof chain, and signed STH} (7.4,-2.0);
  ...
  \draw[<-] (0,-5.1) -- node[below,font=\scriptsize]{verified inclusion or non-inclusion} (7.4,-5.1);
  % verdict
  \node[act,fill=black!8] at (0,-6.15) {return \texttt{null} (safe) or \texttt{MitmWarning}};
\end{tikzpicture}
