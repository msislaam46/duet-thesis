...
\SI{816}{B} --- at parity with CONIKS, while adding automatic detection without enlarging the per-lookup proof --- and
full client verification stays below \SI{150}{\micro\second} and independent of directory size.
