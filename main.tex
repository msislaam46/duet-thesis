...
proof between the last trusted and current tree heads, so a client sends one proof rather than $W$,
with size logarithmic in the endpoint log sizes rather than linear in the epochs it missed.
...
current-head-anchored proof on each of the $W$ occasions. A two-client demonstration shows substitution and equivocation being
