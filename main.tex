...
single-proof offline consistency can be added to a messaging directory at Signal's scale without
changing the asymptotic complexity of the proofs it already serves, using additional lookups of the
existing proof shape; the thesis sets out what remains between the measured prototype and a
