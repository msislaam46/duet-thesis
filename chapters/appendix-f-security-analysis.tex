...
\begin{table}[ht]
\centering
\caption{MITRE ATT\&CK Enterprise techniques mapped to their key-transparency mitigations. Four
...
specific to a malicious \emph{directory} --- observing registration patterns, operating a parallel
encrypted channel, abusing the server's own write authority, selectively censoring writes, or
presenting divergent signed views (equivocation) --- have no precise Enterprise-technique match and
are the thesis's own A1/A2/A4 threats, analyzed through the STRIDE enumeration and the attack
scenarios of \cref{ch:threat} instead.
