...
T1565.002 & Transmitted Data Manipulation & replace a key in transit & label mismatch (different secret) + warning-label propagation & A3 \\
...
Censor warning writes & a strong compound signal (A2): a key mismatch from the self-check together with a proof-verified \emph{absence} of the warning & client out-of-band alert \\
