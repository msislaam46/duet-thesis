...
in the verification chain Goal~G1 (Key-Substitution Detection); pseudorandomness underlies
directory privacy Goal~G3 (Directory Privacy).
\end{definition}
...
returns \textsc{Safe}. The scheme achieves key-substitution detection Goal~G1 (Key-Substitution Detection)
