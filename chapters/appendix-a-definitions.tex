...
\cref{ssec:design-detection}; realized by \textsf{AuditTransition} (\cref{alg:auditor}).
\end{definition}
...
Specified in \cref{ssec:design-detection}; realized by \textsf{PersistenceCheck}
(\cref{alg:detect}).
\end{definition}
