...
rejected. The \textsc{raised} verdict does not depend on the payload MAC of
...
\textsc{clear}. Specified in \cref{ssec:design-verify}.
\end{definition}
...
returns \textsc{clear}. The scheme achieves key-substitution detection Goal~G1 (Key-Substitution Detection)
