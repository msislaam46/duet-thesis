...
sweep. That sweep enumerates the active direct conversations and prunes archived or deleted ones,
so monitoring tracks only conversations the user still holds. No live session-establishment hook
