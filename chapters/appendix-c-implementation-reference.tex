...
appear in \cref{fig:impl-auditor}, left.}
\label{fig:demo-cmd}
\end{figure}
...
as shown in \cref{fig:impl-auditor}, right.}
...
left capture belongs to the run in \cref{fig:demo-cmd}. The auditor verifies the declared history
...
committed state. The right capture shows A4 in a separate reset run, where two validly signed roots
