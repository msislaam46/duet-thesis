...
wipes the log back to a fresh genesis tree between runs, which also consumes any staged one-shot CEA
injection so that each demonstration starts clean. A self-contained walk-through of the client
