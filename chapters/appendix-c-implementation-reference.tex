...
\setlength{\extrarowheight}{2pt}
\small
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}p{4.0cm}>{\raggedright\arraybackslash}X@{}}
\toprule
Method & Path & Purpose \\
\midrule
...
appear in \cref{fig:impl-auditor}, upper panel.}
\label{fig:demo-cmd}
\end{figure}
...
as shown in \cref{fig:impl-auditor}, lower panel.}
