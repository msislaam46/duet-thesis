...
shows the clean A0 baseline, \cref{fig:demo-cmd} shows the A1a and A1b commands,
\cref{fig:impl-screens-fronts,fig:impl-cea-front} show the client-side detection paths,
\cref{fig:demo-equivocation} shows the A4 command, and \cref{fig:impl-auditor} shows the auditor
...
\caption[Commands staging A1a and A1b.]{Commands used to stage A1a and A1b in one controlled run.
...
\caption[A1a self-detection and peer propagation.]{A1a client-side evidence. Bob's account-wide
...
committed state. The lower capture shows A4 in a separate reset run, where two validly signed roots
