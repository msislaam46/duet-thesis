...
maps the runtime arrangement of the embedded client and the three processes it exercises,
...
detection at one shared slot, the victim logging \texttt{WRITE warning slot label=a480\ldots} and the
peer logging \texttt{READ warning slot label=a480\ldots} at the identical hex. The honest baseline is shown in \cref{fig:demo-baseline}, the attacker
