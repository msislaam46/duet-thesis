...
cross the boundary. Finally, the application's typed event bus and those DOM custom events were
mismatched, which was resolved by dispatching on both. Several robustness issues appeared only end to end: a
