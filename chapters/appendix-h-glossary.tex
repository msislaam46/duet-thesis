...
\item[CONIKS] An early key-transparency system that introduced VRF-derived labels and a sparse Merkle
  directory. It is the closest published design point for proof size.
