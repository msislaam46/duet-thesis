...
process verifies directory transitions. In deployment, G4 (Fork Detection) additionally requires
...
remains below \SI{150}{\micro\second} through $10^7$ labels. Windowed catch-up uses one consistency
