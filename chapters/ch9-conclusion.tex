...
same sub-kilobyte size class when their signed heads are excluded. Median latency for the measured
client-side lookup-verification chain remains below \SI{160}{\micro\second} across the tested
directory sizes up to $10^7$ labels. Windowed catch-up uses one consistency
