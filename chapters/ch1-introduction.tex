...
findings. The implemented VRF-indexed lookup proof is roughly comparable in size to the corresponding
CONIKS proof. Detection uses additional label-bound lookups with the same proof format rather than
enlarging an individual proof. Median full-client verification remains below \SI{150}{\micro\second}
