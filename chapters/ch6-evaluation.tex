...
Key-substitution detection & \textbf{automatic in-band peer warning (established conversations)\newline honest-directory VRF identity comparison, supported by different secret-derived labels (first contact)} & manual Safety Number comparison and self-monitoring & optional AKV lookup and self-monitoring\newline no peer warning \\
