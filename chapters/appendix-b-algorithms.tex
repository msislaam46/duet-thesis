...
from Alg.~\ref{alg:dualindex} (labels use sender-then-receiver id order, \cref{ssec:design-modes})}
...
\Fn{\normalfont\textsf{CeaLprint}($\mathit{id_{sender}},\mathit{id_{receiver}}$)}{
  \KwRet $\Hash(k\concat \mathit{id_{sender}}\concat \mathit{id_{receiver}}\concat t)$\;
}
