...
Apple CKV~\cite{apple-ckv} & account keys, device keys, and opt-in state & automatic device verification and E2E-encrypted CloudKit
  cross-check & No & Not documented in the cited source & on-device consistency, encrypted log-hash gossip, and internal audit \\
\bottomrule
\end{tabular}
