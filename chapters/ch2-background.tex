...
ELEKTRA \cite{len2023elektra} & multi-device keychains & self-monitoring & Warning only after account reset & per-update &
  external auditor \\
OPTIKS~\cite{optiks2024} & identity key (and devices) & self-monitoring (single proof, common case) & No &
  verify before old periods are deleted & $\ge$1 auditor and bulletin board \\
