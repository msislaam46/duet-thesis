...
The auditor tests cover both rejection of invalid fork evidence and detection of genuine
equivocation. A real equivocation is reported as \textsc{Fork}, while a divergent head carrying an
invalid signature is rejected outright rather than misclassified as a fork.
...
dispatching on both. The remaining bundling, deterministic-state, and reset detail is described in
