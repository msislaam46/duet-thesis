...
cost is one log-inclusion path, quantified in \cref{ch:eval}. The full alternatives are in
\cref{sec:design-detail-alternatives}. The requirement mapping is in \cref{tab:threat-goals}.
\Cref{tab:design-decisions} summarizes these design choices.
