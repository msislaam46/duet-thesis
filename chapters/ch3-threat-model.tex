...
addresses and the mechanism that delivers it; \cref{app:definitions} defines the formal experiment that makes
each goal precise, and \cref{ch:eval} demonstrates each goal empirically.
