...
\textbf{detection, not prevention}. Thus, the guarantee is not availability. A refusal, a missing
proof, or an invalid response is reported as an unavailable or failed check, not as successful
verification.
