...
chain, as CONIKS and ELEKTRA do, would strengthen this further and is noted as future
work in \cref{ch:discussion}; the prototype relies on the identity re-fetch and the
warning.)
...
G2 offline-window consistency & A4, general rewriting & windowed consistency proofs & no \\
