...
continuous channel but assumes an idealized, honest log. By synthesizing these
...
idealized honest log that ACKA assumes. The \emph{client--network} boundary is
...
(\cref{sec:bg-vkd}), and it lies outside ACKA's model, which trusts the log.
