...
assumptions, in particular the practical basis for the malicious-server assumption and the
...
continuous channel but abstracts the log behind a security definition rather than constructing a
