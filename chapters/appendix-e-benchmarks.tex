...
M8 update, M9, and M13) is between \num{1.6} and \num{4.6} times slower. A run on such a host is not
comparable with this one, and pinning the toolchain does not make the timings portable. Timings are
...
The \SI{0.4}{\micro\second} gap is smaller than either 95\% confidence half-width ($\pm0.43$ and
$\pm0.33$ respectively), so the two modes are indistinguishable at this resolution rather than one
being faster: the chain memoization flattens the compressed-leaf cost that previously separated them.
