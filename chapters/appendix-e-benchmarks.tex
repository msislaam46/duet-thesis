...
Per-check verification cost is $28.0\,\si{\micro\second}$ in session mode and
$27.7\,\si{\micro\second}$ in continuous mode (medians; both include server-side proof
generation, near-identical because the chain memoization flattens the compressed-leaf cost that
previously separated the two modes). Both modes are timed under the identical label-bound proof
